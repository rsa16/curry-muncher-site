...
Absolutely. We welcome feedback and use it to improve future releases. Please use the [error report](/error-report) form linked in the sidebar. If you would like to have a more lengthy discussion about something, join our Discord.
...
## Where can I download your translations?
Our translations are listed on the [series](/novels) page. Each volume has a download tab where you can download a PDF/EPUB, and each series has a link to a folder with each volume's PDF and EPUB. If a download link isn't available, it means that we're still working on that volume. For translations where we translate chapter-by-chapter, we also have PDFs available for the individual chapters.

## How do you translate?
I pretty much go into in-depth detail on this in our [about](/about#translation) page. I also recommend reading our [philosophy](/about#philosophy) as well. If you're looking to learn more about translation, besides reading those, you should read [locksleyu's process of translation](https://selftaughtjapanese.com/2016/10/10/the-art-of-translation-my-process-for-translating-from-japanese-to-english/), [frog-kun's what it's like to translate a novel](https://frogkun.com/2014/05/20/whats-it-like-to-translate-a-light-novel/) and watching the [LTLN series](https://www.youtube.com/playlist?list=PLZZRLam3SpTNBpvDsp9nxFVYsFre-YI46) by Sarah Moon, as all of these are stuff I referenced when I was first starting out (and my own process is largely borrowed from locksleyu's).
...
## Can I reupload your translations?
Hell no. I say as much in every EPUB and PDF, by the way.

## Do you take series suggestions?
...
## Are you guys looking for any staff?
...
## Do you update PDFs/EPUBs after release?
